...
class State {
   public:
    ...
    auto biteval() const -> int_fast8_t {
        if (position[0] & 0b111000000 == 0b111000000)  // highrow
            return 1;
        if (position[0] & 0b000111000 == 0b000111000)  // midrow
            return 1;
        if (position[0] & 0b000000111 == 0b000000111)  // lowrow
            return 1;
        if (position[0] & 0b100010001 == 0b100010001)  // diaglrdown
            return 1;
        if (position[0] & 0b111000000 == 0b111000000)
            return 1;
        if (position[0] & 0b111000000 == 0b111000000)
            return 1;
    }
